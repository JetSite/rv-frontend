...
export const SearchComponent: FC<Props> = () => {
  ...
  return (
    <div className="flex">
      ...
      <Input
        onPressEnter={() => {
          router.push(`/search?serch=${searchValue}`)
        }}
        sx={classNames(
          'border-2 border-l-0 border-h px-2 py-0.5 text-sm font-medium text-gray-700 focus-visible:outline-0 focus:outline-0 active:outline-0',
